...
An instance of CSVRow holds the normalized and validated contents of one row in the CSV representation of a DC Application Profile (DCAP). An instance of the class :class:`dctap.csvrow.CSVRow`:
