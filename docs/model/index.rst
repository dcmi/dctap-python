...
Because the DCTAP Model was designed for compatibility with RDF and Linked Data, property constraints, shapes, literal datatypes, and some value constraints are represented in a :term:`DCTAP CSV File` with :term:`IRI`\s (or :term:`Compact IRI`\s).
